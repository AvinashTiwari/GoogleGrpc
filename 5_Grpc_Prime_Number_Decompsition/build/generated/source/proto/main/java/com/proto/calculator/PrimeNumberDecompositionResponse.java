...
private static final long serialVersionUID = 0L;
  ...
  public static final int PIME_FACTOR_FIELD_NUMBER = 1;
  private int pimeFactor_;
  /**
   * <code>int32 pime_factor = 1;</code>
   */
  public int getPimeFactor() {
    return pimeFactor_;
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (pimeFactor_ != 0) {
      output.writeInt32(1, pimeFactor_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (pimeFactor_ != 0) {
      size += com.google.protobuf.CodedOutputStream
        .computeInt32Size(1, pimeFactor_);
    }
  ...
  public int hashCode() {
    ...
    hash = (37 * hash) + PIME_FACTOR_FIELD_NUMBER;
    hash = (53 * hash) + getPimeFactor();
  ...
  public static final class Builder extends
    ...
    public com.proto.calculator.PrimeNumberDecompositionResponse buildPartial() {
      ...
      result.pimeFactor_ = pimeFactor_;
      onBuilt();
      return result;
    }
    ...
    public Builder mergeFrom(com.proto.calculator.PrimeNumberDecompositionResponse other) {
      ...
      if (other.getPimeFactor() != 0) {
        setPimeFactor(other.getPimeFactor());
      }
     ...
     * <code>int32 pime_factor = 1;</code>
     */
    public Builder setPimeFactor(int value) {
     ...
     * <code>int32 pime_factor = 1;</code>
     */
    public Builder clearPimeFactor() {
